...
* sensor.accel.common.spin2h (provided by spin-standard-library)
* sensor.magnetometer.common.spin2h (provided by spin-standard-library)
...
| P2        | SPIN2    | FlexSpin (7.4.2)       | NuCode       | FTBFS                 |
